...
public class FragmentHome extends Fragment {
    ...
    private BlurSingle.BlurLayout blurLayout1,blurLayout2,blurLayout3,blurLayout4;
            ...
            switch (msg.what){
                ...
                case msg_login:
                    ...
                    if(user.getUserpic()!=null&&(!user.getUserpic().equals(""))){
                        Glide.with(getContext()).load(ConstValue.url_picUser(user.getUserpic()))
                                .apply(options)
...
//        startActivityForResult(intentToTakePhoto, REQUEST_CAMERA);
    ...
    public void setBlur(){
        ...
        blurLayout1=new BlurSingle.BlurLayout(layout_1,bkg_layout);
        blurLayout2=new BlurSingle.BlurLayout(layout_2,bkg_layout);
        blurLayout3=new BlurSingle.BlurLayout(layout_3,bkg_layout);
        blurLayout4=new BlurSingle.BlurLayout(layout_4,bkg_layout);
    }
}
