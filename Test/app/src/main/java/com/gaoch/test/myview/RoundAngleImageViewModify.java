...
public class RoundAngleImageViewModify extends androidx.appcompat.widget.AppCompatImageView {
    private Paint paint;
    /**
     * 个人理解是
     *
    ...
    public RoundAngleImageViewModify(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public RoundAngleImageViewModify(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RoundAngleImageViewModify(Context context) {
        super(context);
        init(context, null);
    }
